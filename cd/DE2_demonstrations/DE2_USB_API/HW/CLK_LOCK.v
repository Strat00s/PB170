...
module  CLK_LOCK_altclkctrl_6df
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //CLK_LOCK_altclkctrl_6df
//VALID FILE
...
module CLK_LOCK (
	...
	CLK_LOCK_altclkctrl_6df	CLK_LOCK_altclkctrl_6df_component (
				.clkselect (sub_wire1),
				.ena (sub_wire2),
				.inclk (sub_wire4),
				.outclk (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL CLK_LOCK.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL CLK_LOCK.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CLK_LOCK.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CLK_LOCK.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CLK_LOCK_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL CLK_LOCK_bb.v FALSE
