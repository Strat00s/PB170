...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE2_NIOS_HOST_MOUSE_VGA.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1b02108
SOPC_SYSID_FLAG += --sidp=0x1b02108
ELF_PATCH_FLAG  += --sidp 0x1b02108

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1327911752
SOPC_SYSID_FLAG += --timestamp=1327911752
ELF_PATCH_FLAG  += --timestamp 1327911752
